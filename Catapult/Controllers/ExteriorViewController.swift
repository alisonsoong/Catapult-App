...
class ExteriorViewController: UIViewController, UITableViewDataSource, UINavigationControllerDelegate, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.defaults.set("exterior", forKey: self.categoryKey)
        ...
        if (self.defaults.object(forKey: self.exteriorPhotosKey) == nil){
            ...
            self.photoList = self.defaults.object(forKey: self.exteriorPhotosKey) as! [String]
...
extension ExteriorViewController:  ImageTableViewCellDelegate {
    ...
    func deleteButtonPressed(with row: Int) {
        ...
        if (row >= 0 && row < photoList.count){
            ...
            self.defaults.set(photoList, forKey: self.exteriorPhotosKey)
