...
class OtherViewController: UIViewController, UITableViewDataSource, UINavigationControllerDelegate, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.defaults.set("other", forKey: self.categoryKey)
        ...
        if (self.defaults.object(forKey: self.otherPhotosKey) == nil){
            ...
            self.photoList = self.defaults.object(forKey: self.otherPhotosKey) as! [String]
...
extension OtherViewController:  ImageTableViewCellDelegate {
    ...
    func deleteButtonPressed(with row: Int) {
        ...
        if (row >= 0 && row < photoList.count){
            ...
            self.defaults.set(photoList, forKey: self.otherPhotosKey)
