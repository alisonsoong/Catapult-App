...
class KitchenViewController: UIViewController, UITableViewDataSource, UINavigationControllerDelegate, UITableViewDelegate {
    ...
    override func viewDidLoad() {
        ...
        self.defaults.set("kitchen", forKey: self.categoryKey)
        ...
        if (self.defaults.object(forKey: self.kitchenPhotosKey) == nil){
            ...
            self.photoList = self.defaults.object(forKey: self.kitchenPhotosKey) as! [String]
...
extension KitchenViewController:  ImageTableViewCellDelegate {
    ...
    func deleteButtonPressed(with row: Int) {
        ...
        if (row >= 0 && row < photoList.count){
            ...
            self.defaults.set(photoList, forKey: self.kitchenPhotosKey)
